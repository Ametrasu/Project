        ...
        <div className="container">
            <div>
                <div className="row m-4">
                    ...
                    <div className="col-md-4">
                        ...
                        <p>ReactJS is highly popular because of its simplicity and flexibility. 
                            ...
                            It is estimated that more than 1,300 developers and over 94,000 sites use ReactJS.</p>
                    </div>
                    <div className="col-md-4">
                        <h3>Strength</h3>
                        <ul>
                ...
                <div className="row ml-2">
                    <h1 className="p-4 text-center">Apps using React</h1>
                ...
                <div className="row m-4">
                    ...
                    <div className="col-md-4">
                        ...
                        <p>The popularity of Laravel framework is on the rise due to its 
                            incredible features. It has a simple and elegant syntax that is easy to learn and has a strongly secure ecosystem. 50% of PHP Developers use Laravel regularly.</p>
                    </div>
                    <div className="col-md-4">
                        <h3>Strength</h3>
                        <ul>
                    ...
                    <div className="col-md-4">
                        ...
                        <ul>
                            ...
                            <li>Hard legacy systems</li>
                            <li>Slow Performance</li>
                        </ul>
                    </div>
                    <div className="row ml-2">
                    <h1 className="p-4 text-center">Apps using Laravel</h1>
                    <div className="col-md-4 col-sm-12">
